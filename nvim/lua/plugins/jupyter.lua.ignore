...
return {
  {
    "goerz/jupytext.vim", -- Open jupyter notebooks
    ...
    config = function()
      ...
      -- formats at https://jupytext.readthedocs.io/en/latest/formats-scripts.html (default: None)
  ...
  -- Not happy!
  {
    ...
    -- end,
    -- keys = {
    --   { "<leader>rc",    execute_cell,                                                   desc = "Execute Cell" },
    --   { "<leader>ic",    insert_code_cell,                                               desc = "Insert Code Cell" },
    --   { "<leader>im",    insert_markdown_cell,                                           desc = "Insert Markdown Cell" },
    --   { "<leader>rx",    delete_cell,                                                    desc = "Delete Cell" },
    --   { "<leader>nc",    navigate_cell,                                                  desc = "Next Cell" },
    --   { "<leader>pc",    function() navigate_cell(true) end,                             desc = "Previous Cell" },
